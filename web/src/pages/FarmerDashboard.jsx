...
import { 
  ...
  Sparkles, Loader2, IndianRupee, MapPin, Store, CheckCircle, Clock, ArrowRight, MessageCircle, User, BarChart3, Star, Globe
} from 'lucide-react';
                    ...
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-5">
                        ...
                        {order.status === 'accepted' && (
                          <span className="text-slate-500 font-black">{t('awaiting_logistics')}</span>
                        )}
                        ...
                        {(order.status === 'delivered' || order.status === 'cancelled') && (
                          <span className="text-slate-400 font-black">{t('completed')}</span>
                        )}
                        <button
