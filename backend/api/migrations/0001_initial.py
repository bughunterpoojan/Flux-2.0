    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('fruits', 'Fruits'), ('vegetables', 'Vegetables'), ('grains', 'Grains'), ('dairy', 'Dairy'), ('organic', 'Organic')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('farmer_counter_price', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('accepted', 'Accepted'), ('countered', 'Countered'), ('rejected', 'Rejected')], default='pending', max_length=20)),
